...
<br /><br />
In defence their abilities are average at best.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 5, <a href="manual.php?typ=4&amp;gid=20">Stable</a> Level 3</div><map id="nav" name="nav">
