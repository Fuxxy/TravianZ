...
<img id="big_unit" class="big_u2" src="img/x.gif" alt="Praetorian" title="Praetorian" /><div id="t_desc">The Praetorians are the emperor's guard and they defend him with their life. Because their training is specialized for defence, they are very weak attackers.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 1, <a href="manual.php?typ=4&amp;gid=13">Armoury</a> Level 1</div><map id="nav" name="nav">
