...
<br />
HINT: The Trebuchet CAN hit the cranny, trappers or stonemason's lodges when it targets randomly.</div><div id="prereqs"><b>Prerequisites</b><br /><a href="manual.php?typ=4&amp;gid=21">Workshop</a> Level 10, <a href="manual.php?typ=4&amp;gid=22">Academy</a> Level 15</div><map id="nav" name="nav">
