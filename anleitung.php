...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title><?php echo SERVER_NAME."&nbsp;-&nbsp;".INSTRUCT; ?></title>
    ...
    <body class="webkit contentPage">
        <div class="wrapper">
            ...
            <div id="navigation">
                ...
                <table class="menu">
                    <tr>
                        ...
                        <td><a href="anleitung.php"><span><?php echo INSTRUCT; ?></span></a></td>
                        <td><a href="http://forum.travian.com/" target="_blank"><span><?php echo FORUM; ?></span></a></td>
                        <td><a href="index.php?signup" class="mark"><span><?php echo REG; ?></span></a></td>
            ...
            <div id="content">
                <div class="grit">
                    <h1><?php echo INSTRUCT; ?></h1>
                    <p class="submenu">
                        <a href="anleitung.php"><?php echo THE_TRIBES; ?></a> |
                        <a href="anleitung.php?s=1"><?php echo THE_BUILDINGS; ?></a> |
                        <a href="anleitung.php?s=3"><?php echo FAQ1; ?></a> |
                        <a href="anleitung.php?s=4"><?php echo FAQ2; ?></a>
                    </p>
                    <?php
                    if (!isset($_GET['s'])) {
                        $_GET['s'] = "";
